...
This session begins the journey defined in:

- 📌 **[ROADMAP-INDEX.md](../Roadmap/ROADMAP-INDEX.md)** — Master index, overview, and exit criteria
- 🔧 **[PHASE-0-LAB-SETUP.md](../Roadmap/PHASE-0-LAB-SETUP.md)** — Next active phase

**Current Phase:** Phase 0 — Lab Setup (Weeks 1–2)
...
|---|---|---|
| Monday | **Track A — Web3 / Smart Contracts** | Competitive audit + SENTINEL extension |
| Tuesday | **Track B — AI/ML Security** | Adversarial attack on SENTINEL + LLM red team suite |
...
See **[REFERENCE-TOOLS.md](../Roadmap/REFERENCE-TOOLS.md)** for the full categorized list.

---

## Next Steps

1. Open **[PHASE-0-LAB-SETUP.md](../Roadmap/PHASE-0-LAB-SETUP.md)** and walk through the lab architecture
