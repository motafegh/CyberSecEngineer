...
The Architecture Spine is not a reference to read once. Apply it at three cadences.

### At Module End

After completing any module, answer the following sections for the system studied or built in that module:

- Section 2.1 — System Boundary: state exactly what is inside and outside the module's system.
- Section 2.2 — Trust Boundaries: identify where trust changes in the module's system.
- Section 2.8 — Attack Paths: identify the two or three most realistic attack paths against the module's system.

Write answers in your notes. Do not skip this because the module felt conceptual. Apply the questions to the conceptual system.

### At Phase End

After completing a phase, answer all eleven sections (2.1 through 2.11) for the phase capstone system. This should take one to two hours and produces the clearest signal of whether architecture thinking is developing.

Produce at minimum:

- [ ] System context diagram (section 3.1)
- [ ] Trust boundary diagram (section 3.3)
- [ ] Threat model (section 3.4)
- [ ] At least one Architecture Decision Record (section 3.5)

### At Capstone

For Phase 6 and any other full-synthesis capstone, produce all seven artifacts (sections 3.1 through 3.7). These artifacts are the primary evidence of principal-level capability. They should be portfolio-ready.

### Calibration Check

If applying the spine questions to a system produces mostly empty answers, the system is either too vague or the architecture thinking is not yet deep enough. Either define the system more concretely or return to the relevant modules before proceeding.
