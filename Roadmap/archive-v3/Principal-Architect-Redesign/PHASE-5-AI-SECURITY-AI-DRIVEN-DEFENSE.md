...
- [ ] Train or load a small model on a harmless dataset.
- [ ] Create a simple evasion example.
- [ ] Measure success rate.
- [ ] Perform a basic poisoning experiment.
- [ ] Demonstrate model extraction concept with a toy classifier.
