...
- [ ] Map controls to recognized risk frameworks and quantify risk.
...
## 5. Module 6.1b — Risk Frameworks and Security Posture Measurement

### Why This Matters

A principal architect designs controls, but executives, auditors, and GRC teams think in frameworks. Knowing which framework bucket a control maps to — and how to quantify and prioritize risk — is what lets an architect's decisions survive contact with governance, audit, and budget conversations.

### Core Concepts

- NIST Cybersecurity Framework (CSF): Identify, Protect, Detect, Respond, Recover
- NIST SP 800-53 control families (for framework literacy, not full compliance depth)
- ISO 27001 structure: ISMS, Annex A controls, certification scope
- CVSS (Common Vulnerability Scoring System) for technical severity
- EPSS (Exploit Prediction Scoring System) for real-world exploitation likelihood
- Security posture KPIs (mean time to detect, mean time to remediate, patch SLA adherence, coverage metrics)
- Risk quantification concepts (qualitative vs quantitative risk, expected loss framing)

### Hands-On Exercises

- [ ] Map five controls already built in this roadmap (e.g., mTLS, policy-as-code, secret scanning, MFA, network segmentation) to their NIST CSF function and at least one NIST 800-53 or ISO 27001 Annex A control family.
- [ ] Score three vulnerabilities found earlier in the roadmap using CVSS and explain the score.
- [ ] Look up or estimate EPSS scores for the same three vulnerabilities and compare prioritization under CVSS-only vs CVSS+EPSS.
- [ ] Design three security posture KPIs for the Phase 3 or Phase 6 capstone platform, with target thresholds.
- [ ] Write a one-page framework crosswalk: "If a GRC team asks where this control lives in ISO 27001, NIST CSF, and 800-53, here is the answer."
- [ ] Write a short risk quantification example: convert one qualitative "High" risk into an expected-loss style estimate, stating all assumptions explicitly.

### Recall Checks

- Why does framework literacy matter for an architect who isn't doing compliance work directly?
- Why is EPSS a useful complement to CVSS rather than a replacement?
- What is the risk of choosing security posture KPIs that are easy to measure but don't reflect actual risk reduction?

### Exit Criteria

- [ ] Framework crosswalk completed for at least five controls.
- [ ] CVSS and EPSS scoring exercise completed for three vulnerabilities.
- [ ] Three posture KPIs defined with thresholds.
- [ ] Risk quantification example completed.

---

## 6. Module 6.2 — Reference Architecture Design
...
## 7. Module 6.3 — Advanced Threat Modeling and Risk Registers
...
## 8. Module 6.4 — Security Governance and Guardrails
...
## 9. Module 6.5 — Incident-Ready Architecture
...
## 10. Module 6.6 — Executive and Technical Communication
...
## 11. Final Capstone — Secure Distributed Trust Platform
...
## 13. Phase 6 Exit Criteria

- [ ] Risk frameworks and posture measurement module completed.
